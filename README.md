...
|-----------------------|-----------|--------|
| **1. Years lived in this neighborhood?** | Write a number: (____) years | ≥18 years: **3 points** |
| **2. Years lived in the U.S.?** | Write a number: (____) years | <10 years: **2 points** |
| **3. People in household (excluding yourself)?** | Write a number: (____) people | Living with 1 person: **1 point** |
...
| **9. Number of hospitalizations in the past 2 years?** | Write a number: (____) times | More than once: **1 point** |
...
| **15. Number of biological children alive?** | Write a number: (____) children | ≤2: **2 points** |
